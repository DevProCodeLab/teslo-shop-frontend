...
export const ProductForm = ({
    ...
    const addTag = () => {
        if (tagRef.current?.value.trim() && !selectedtags.includes(tagRef.current.value.trim())) {
            const tagsSet = new Set(getValues('tags'));
            tagsSet.add(tagRef.current.value);
                                ...
                                <div className="flex flex-wrap gap-2 pt-2 border-t border-slate-200">
                                    ...
                                    {availableSizes.map((size) => (
                                        <button
                                            ...
                                            className={`px-3 py-1 rounded-full text-sm font-medium transition-all duration-200 ${selectedSize.includes(size)
